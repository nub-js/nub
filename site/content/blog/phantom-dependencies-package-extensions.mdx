...
The [dephantom package directory](https://dephantom.vercel.app/packages/) lists the packages by estimated weekly npm downloads, with expandable version ranges and available evidence. The [project homepage](https://dephantom.vercel.app/#maintainers) covers dependency declarations and optional integrations.
