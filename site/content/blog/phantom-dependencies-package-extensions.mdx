...
The [dephantom package directory](https://dephantom.vercel.app/packages/) lists the packages by recorded download rank, with the version scanned and source references for each finding. It also includes a [maintainer guide](https://dephantom.vercel.app/guide/) covering dependency declarations and optional integrations.
