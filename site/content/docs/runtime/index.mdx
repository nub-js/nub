...
- **[Threadpool](/docs/runtime/threadpool)** — libuv's threadpool is sized to the cores available to the process instead of Node's fixed four, with the extra threads at a lower priority on Linux.
